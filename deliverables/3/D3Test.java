...
public class D3Test {
  ...
  public void fUNCATHY() {
    driver.get("https://cs1632.appspot.com/");
    driver.manage().window().setSize(new Dimension(972, 1040));
  ...
  public void fUNLINKS() {
    driver.get("https://cs1632.appspot.com/");
    {
      ...
      vars.put("homeButton", attribute);
    }
    assertEquals(vars.get("homeButton").toString(), "https://cs1632.appspot.com/");
  }
  @Test
  ...
  public void dEFECT2FUNINVALIDVALUE() {
    ...
    driver.findElement(By.cssSelector("input:nth-child(2)")).click();
    assertThat(driver.findElement(By.cssSelector("h2")).getText(), is("Factorial of hello is 1!"));
  }
  @Test
